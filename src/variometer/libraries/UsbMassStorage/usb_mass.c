...
extern DEVICE_PROP Device_Property_mass;
extern ONE_DESCRIPTOR Device_Descriptor_mass;
extern ONE_DESCRIPTOR Config_Descriptor_mass;
extern ONE_DESCRIPTOR String_Descriptor_mass[];
extern usb_descriptor_config usbMassConfigDescriptor;
extern USER_STANDARD_REQUESTS User_Standard_Requests_mass;

#define Device_Property			Device_Property_mass
#define Device_Descriptor		Device_Descriptor_mass
#define Config_Descriptor		Config_Descriptor_mass
#define String_Descriptor		String_Descriptor_mass
#define User_Standard_Requests	User_Standard_Requests_mass
 ...
 *
 */
void usb_init_usblib_mass(usblib_dev *dev,
                     void (**ep_int_in)(void),
...
void usb_mass_enable(gpio_dev *disc_dev, uint8 disc_bit) {
  ...
  usb_init_usblib_mass(USBLIB, ep_mass_int_in, ep_mass_int_out);
}
